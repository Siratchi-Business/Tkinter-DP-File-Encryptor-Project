...
root.iconbitmap("../IMG/Graphicloads-Flat-Finance-Lock.ico")
...
title_label = Label(page1, text='🔒 Benvingut a l`Encriptador d`Arxius DP 🔓', font="Verdana 15 bold", bg="darkcyan",
                    fg="white")
...
insert_pathfile = Label(page2, text='Introduïu la ruta absoluta del fitxer: ', font="Verdana 13 bold", bg="lightblue",
                        fg="white")
encriptention_numbers = Label(page2, text=f'Numero de veces encriptado: {str(numbers_of_encriptation)}',
                              font="Verdana 13 bold", bg="lightblue", fg="white")
...
encrypt_alternative_button = Button(page2, text=" Selccionar un arxiu ", font="Verdana 9 bold", compound="left",
                                    bg="white", fg="darkcyan", command=select_to_encrypt, image=select_file_image)
encrypt_Button = Button(page2, text="Encriptar arxiu", font="Verdana 13 bold", bg="darkcyan", fg="white",
...
insert_pathfile2 = Label(page3, text='Introduïu la ruta absoluta del fitxer: ', font="Verdana 13 bold", bg="lightblue",
                         fg="white")
desncriptention_numbers = Label(page3, text=f'numeros de veces a desencrpitar: {str(numbers_of_encriptation)}',
                                font="Verdana 13 bold", bg="lightblue", fg="white")
...
encrypt_alternative_button2 = Button(page3, text=" Selccionar un arxiu ", font="Verdana 9 bold", compound="left",
                                     bg="white", fg="darkcyan", command=select_to_encrypt2, image=select_file_image)
Desencrypt_Button = Button(page3, text=" Desxifrar arxiu", font="Verdana 13 bold", bg="darkcyan", fg="white",
...
methode_changes = Button(page4, text="Canviar Metode", font="Verdana 13 bold", bg="lightcyan",
                         command=change_method_dialog)
...
example_pathfile = Label(page5, text="Exemple de com es una ruta absoluta del arxiu:", font="Verdana 13 bold",
...
alternative_pathfile_example = Label(page5, text="Un altre exemple: ", font="Verdana 13 bold", bg="lightblue",
                                     fg="white")
...
# TODO: Añadir sistema de deteccion para registrar la veces que se ha encriptado y desencriptador(log).
# TODO: Organizar el codigo en funciones i Orientarlo a objetos.
